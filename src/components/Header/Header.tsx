...
import LogoX from "../../assets/logo/admin-ajax (1).png";
    ...
    <div className="header-container">
      ...
      <div className="header-menu-container">
        <div className="cart-header-container" onClick={() => navigate("/korpa")}>
          <ShoppingCartOutlinedIcon sx={{ fontSize: 40, color: '#000000', cursor: 'pointer' }} />
        ...
        <div className="login-container" onClick={() => navigate(user ? "/profil" : "/prijava")}>
          <AccountCircleOutlinedIcon sx={{ fontSize: 40, color: '#000000' }} />
        ...
        {isAdmin && (
          <div className="admin-icon-container" onClick={() => navigate("/admin/panel")}>
            <AdminPanelSettingsOutlinedIcon sx={{ fontSize: 40, color: '#000000' }} />
